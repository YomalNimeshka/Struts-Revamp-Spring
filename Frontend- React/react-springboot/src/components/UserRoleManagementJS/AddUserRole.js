...
class AddUserRole extends Component {
    ...
    submitUserRole = (event) => {
        ...
        console.log(userD)
        UserRoleManagementService.addUserRoleManagement(userD).then((res) => {
        ...
        return (
            <div style={container}>
                <Card className={"border border-dark bg-dark text-white"}>
                    <Card.Header><h1>Add User Role</h1></Card.Header>
                    <Card.Body>
                        <Form id='addUserRole' onSubmit={this.submitUserRole}>
